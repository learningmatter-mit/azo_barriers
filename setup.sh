...
if [ -d "NeuralForceField" ]; then
    ...
    git clone git@github.com:learningmatter-mit/NeuralForceField.git || echo 'FAILED to clone NFF. Please check your ssh permissions and then run `cd .. && git clone git@github.com:learningmatter-mit/NeuralForceField.git`'
fi
